...
class ExportScreenState extends State<ExportScreen> {
  ...
  List<String> get exportOptions => [
        S.of(context).export_grades,
        S.of(context).export_lessons,
        S.of(context).export_accounts
      ];
                ...
                children: <Widget>[
                  ...
                  (selectedData == 1)
                      ? new MaterialButton(
                          ...
                          child: new Text(
                              selectedDate ?? S.of(context).export_interval),
                        )
                      : new Container(),
                  (selectedData != 2)
                      ? new DropdownButton(
                          ...
                          onChanged: (exportFormat) async {
                            selectedFormat =
                                formatOptions.indexOf(exportFormat);
                        ...
                        switch (selectedData) {
                          case 0:
                            ...
                            switch (selectedFormat) {
                              ...
                              case 0:
                                ...
                                String data =
                                    selectedAccount.getStudentString();
                                File file = File(path);
                                  ...
                                  file.writeAsString(data).then((File f) {
                                    if (f.existsSync())
                                      Fluttertoast.showToast(
                                          msg: S.of(context).export_success +
                                              ": " +
                                              path,
                          ...
                          case 1:
                            ...
                            switch (selectedFormat) {
                              //json
                              case 0:
                                String data = await getLessonsJson(
                                    pickedDate[0],
                                    pickedDate[1],
                                    selectedUser,
                                    true);
