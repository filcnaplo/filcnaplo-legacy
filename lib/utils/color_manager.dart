...
Color getColors(BuildContext context, int value, bool getBackground) {
  switch (value) {
    ...
    case 1:
      return getBackground ? globals.color1 : globals.colorF1;
    case 2:
      return getBackground ? globals.color2 : globals.colorF2;
    case 3:
      return getBackground ? globals.color3 : globals.colorF3;
    case 4:
      return getBackground ? globals.color4 : globals.colorF4;
    case 5:
      return getBackground ? globals.color5 : globals.colorF5;
    default:
      return getBackground ? Colors.white : Colors.black;
  }
}
  ...
  ThemeData getTheme(brightness) {
    ...
    if (brightness != 0) {
      ...
      return ThemeData(
        ...
        cardColor:
            brightness.index == 0 ? Color.fromARGB(255, 25, 25, 25) : null,
